  ...
  return (
    <div className="min-h-screen page-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Welcome Banner */}
        <div className="bg-gradient-to-r from-primary-500 to-purple-600 rounded-2xl p-8 mb-8 text-white shadow-xl animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Updated Section Header with Join Class Button */}
            ...
            {classes.length === 0 ? (
              <div className="card text-center py-12">
                ...
                <p className="text-gray-500 mb-4">Get started by enrolling in your first class!</p>
                <button 
                  onClick={() => navigate('/student/join-class')}
                ...
                {classes.map((cls) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span className="badge-info">{cls.code}</span>
                    </div>
